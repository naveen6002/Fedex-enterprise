...
function PluginProvider(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(PluginContext.Provider, {
...
function SeriesProvider(props) {
  ...
  return (0, import_jsx_runtime5.jsx)(SeriesContext.Provider, {
    value: formattedSeries,
    children
  });
}
...
var AnimationContext = React33.createContext({
  isInitialized: false,
  data: {
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React34.useContext(AnimationContext);
  if (!isInitialized) {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React35.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React38.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React38.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React39.useRef(null);
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  const stateRef = React41.useRef({
    displayError: false,
    initialCompute: true,
    computeRun: 0
  });
  const rootRef = React41.useRef(null);
  const [width2, setWidth] = React41.useState(0);
  const [height2, setHeight] = React41.useState(0);
...
function ChartsText(props) {
  ...
  const wordsByLines = React43.useMemo(() => getWordsByLines({
    style: style4,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime19.jsxs)(React47.Fragment, {
...
function deepClone(source) {
  if (React50.isValidElement(source) || (0, import_react_is.isValidElementType)(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function deepmerge(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach((key) => {
      if (React50.isValidElement(source[key]) || (0, import_react_is.isValidElementType)(source[key])) {
...
function useTheme2(defaultTheme4 = null) {
  const contextTheme = React51.useContext(ThemeContext);
...
var useEnhancedEffect = typeof window !== "undefined" ? React53.useLayoutEffect : React53.useEffect;
...
var PropsContext = React58.createContext(void 0);
...
function isMuiElement(element, muiNames) {
  var _a, _b, _c;
  return React64.isValidElement(element) && muiNames.indexOf(
  ...
  const Grid2 = React65.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime31.jsx)(GridRoot, {
      ...
      children: React65.Children.map(children, (child) => {
        var _a;
        if (React65.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React70.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React70.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React75.useMemo(
  ...
  const padding2 = React75.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React75.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React75.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React75.useMemo(() => {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime44.jsxs)(React81.Fragment, {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SF524V73.js.map
